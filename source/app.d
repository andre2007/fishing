...
class FishingWindow : MainWindow
{
	...
	void addFishSpecies()
	{
		...
		dialog((NewSpecies ns) {
			string speciesName = ns.EnterSpecies.strip;
...
class FishDatabase
{
	...
	string asHtmlTable()
	{
		string result = `<html><head>
			...
			<td>Fischart</td>
			<td>Abschnitt 1 Stück</td>
			<td>kg</td>
			<td>Abschnitt 2 Stück</td>
			<td>kg</td>
			<td>Abschnitt 3 Stück</td>
			<td>kg</td>
			<td>Abschnitt 4 Stück</td>
			<td>kg</td>
			<td>Abschnitt 5 Stück</td>
			<td>kg</td>
			<td>Abschnitt 6 Stück</td>
			<td>kg</td>
			<td>Gesamt Stück</td>
			<td>Gesamt kg</td>
			</tr>`;
